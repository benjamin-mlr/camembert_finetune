...
from camembert_finetune.env.imports import pdb, OrderedDict, np, torch, time
from camembert_finetune.model.settings import LABEL_PARAMETER

from camembert_finetune.model.constants import PAD_ID_LOSS_STANDART, ROOT_HEADS_INDEX, END_HEADS_INDEX
from camembert_finetune.model.optimization.masking import dropout_mlm
...
def get_label_per_bpe(tasks, batch, input_tokens_tensor, input_alignement_with_raw, use_gpu, tasks_parameters,
    ...
    return head_masks, input_tokens_tensor, token_type_ids, label_per_task, input_tokens_tensor_per_task, input_mask_per_task, cumulate_shift
