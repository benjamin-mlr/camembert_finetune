...
from camembert_finetune.io_.printout_iterator_as_raw import outputing_raw_data_from_iterator
...
def data_gen_conllu(data, word_dictionary, char_dictionary,
    ...
    printing("TRAINING : Task {} Running {} batches of {} dim (n_sents : {}  time(s)) (if 0 will be set to 1) ".format(task_info, nbatch, batch_size, n_sents), verbose=verbose, verbose_level=2)
    printing("ITERATOR INFO : 1 epoch is {} iteration/step/batch  ", var=[nbatch], verbose=verbose, verbose_level=2)
