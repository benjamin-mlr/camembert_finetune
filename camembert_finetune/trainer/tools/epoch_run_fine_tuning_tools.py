from camembert_finetune.env.imports import torch, re, OrderedDict
from camembert_finetune.io_.logger import printing
from camembert_finetune.model.settings import TASKS_PARAMETER
from camembert_finetune.model.constants import SPECIAL_TOKEN_LS
from camembert_finetune.io_.dat.normalized_writer import write_conll, write_conll_multitask
...
def tensorboard_loss_writer_epoch_level_multi(writer, mode, model_id, epoch, loss_dic, n_tokens_dic, data_label, penalization_dic=None, group_mapping=None):
    """
...
def writing_predictions_conll_multi(dir_pred, dir_normalized_original_only,
                                    ...
                                    sent_ids=None, raw_texts=None,
                                    append_mwe_ind=None, append_mwe_row=None,
    ...
    write_conll_multitask(format="conll", dir_pred=dir_pred,
                          ...
                          sent_id=sent_ids, raw_text=raw_texts,
