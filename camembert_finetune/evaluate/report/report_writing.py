from camembert.downstream.finetune.env.imports import pdb, sys, os
from camembert.downstream.finetune.model.settings import TASKS_PARAMETER

from camembert.downstream.finetune.evaluate.score.confusion_matrix_rates import get_perf_rate
...
def report_score_all(evaluated_task, agg_func_ls, samples, label_heuristic, score_dic, n_tokens_dic, n_sents_dic,
    ...
    for task in list(set(evaluated_task)):
        ...
        #pdb.set_trace()
        #evaluated_tasks_confusion_matrix_based_score = ["normalize"]
