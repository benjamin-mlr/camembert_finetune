from camembert_finetune.env.imports import CrossEntropyLoss
from camembert_finetune.io_.dat.constants import PAD_ID_TAG, PAD_ID_HEADS
from camembert_finetune.model.constants import PAD_ID_LOSS_STANDART
#optimizer setting
AVAILABLE_OPTIMIZER = ["adam", "bahdanu-adadelta", "SGD", "AdamW"]
AVAILABLE_BERT_FINE_TUNING_STRATEGY = ["bert_out_first", "standart", "flexible_lr", "only_first_and_last", "freeze"]
